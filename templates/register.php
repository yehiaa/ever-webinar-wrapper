            ...
            <div class="col-md-12">
                <form method="post" id="register-form" data-toggle="validator">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required class="form-control input-lg" id="name" placeholder="Your Name" data-minlength="4">
                    <div class="help-block with-errors"></div>
                  </div>

                  <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" required class="form-control input-lg" id="email" placeholder="Your Email">
                    <div class="help-block with-errors"></div>
                  </div>
